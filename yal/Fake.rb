...
class Yal
    def cli_fake(*args)
        ...
        (1..100).each do |i|
            ...
            spCat_10 = "shared"
            spCat_11 = "travel"
            spImage_1  = "images/spImage_1-child-#{i}"
            spImage_2  = "images/spImage_2-face-#{i}"
            spImage_3  = "images/spImage_3-food-#{i}"
            spImage_4  = "images/spImage_4-friend-#{i}"
            spImage_5  = "images/spImage_5-friends-#{i}"
            spImage_6  = "images/spImage_6-interest-#{i}"
            spImage_7  = "images/spImage_7-love-#{i}"
            spImage_8  = "images/spImage_8-pet-#{i}"
            spImage_9  = "images/spImage_9-relevant-#{i}"
            spImage_10 = "images/spImage_10-shared-#{i}"
            spImage_11 = "images/spImage_11-travel-#{i}"
            spTS_1  = "spTS_1-#{i}"
            spTS_2  = "spTS_2-#{i}"
            spTS_3  = "spTS_3-#{i}"
            spTS_4  = "spTS_4-#{i}"
